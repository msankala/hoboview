...
class PanoramasControllerTest < ActionController::TestCase
  ...
  test "should create panorama" do
    assert_difference('Panorama.count') do
      post :create, panorama: { center: @panorama.center, copyright: @panorama.copyright, description: @panorama.description, heading: @panorama.heading, image: @panorama.image, title: @panorama.title }
    end
  ...
  test "should update panorama" do
    patch :update, id: @panorama, panorama: { center: @panorama.center, copyright: @panorama.copyright, description: @panorama.description, heading: @panorama.heading, image: @panorama.image, title: @panorama.title }
    assert_redirected_to panorama_path(assigns(:panorama))
  end
